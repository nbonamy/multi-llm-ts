...
test('Meta Load Chat Models', async () => {
  ...
  expect(models!.chat).toStrictEqual([
    { id: 'Llama-4-Maverick-17B-128E-Instruct-FP8', name: 'Llama-4-Maverick-17B-128E-Instruct-FP8', meta: expect.any(Object), capabilities: { responses: expect.any(Boolean), tools: true, vision: true, reasoning: false } },
    { id: 'Llama-3.3-8B-Instruct', name: 'Llama-3.3-8B-Instruct', meta: expect.any(Object), capabilities: { responses: expect.any(Boolean), tools: true, vision: false, reasoning: false } },
  ])
