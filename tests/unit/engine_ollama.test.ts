...
test('Ollama Load Models', async () => {
  ...
  expect(models!.chat).toStrictEqual([
    { id: 'cogito:latest', name: 'cogito', meta: { model: 'cogito:latest', name: 'cogito' }, capabilities: { responses: expect.any(Boolean), tools: true, vision: false, reasoning: false } },
    { id: 'gemma3:latest', name: 'gemma3', meta: { model: 'gemma3:latest', name: 'gemma3' }, capabilities: { responses: expect.any(Boolean), tools: false, vision: true, reasoning: false } },
    { id: 'model:7b', name: 'model', meta: { model: 'model:7b', name: 'model' }, capabilities: { responses: expect.any(Boolean), tools: true, vision: false, reasoning: false } },
  ])
  expect(models!.embedding).toStrictEqual([
    { id: 'embed:latest', name: 'embed', meta: { model: 'embed:latest', name: 'embed' }, capabilities: { responses: expect.any(Boolean), tools: false, vision: false, reasoning: false } },
  ])
