...
test('MistralAI Load Models', async () => {
  ...
  expect(models!.chat).toStrictEqual([
    { id: 'magistral6', name: 'magistral6', meta: expect.any(Object), capabilities: { responses: expect.any(Boolean), tools: false, vision: false, reasoning: true } },
    { id: 'model5', name: 'model5', meta: expect.any(Object), capabilities: { responses: expect.any(Boolean), tools: false, vision: true, reasoning: false } },
    { id: 'model4', name: 'Model 4', meta: expect.any(Object), capabilities: { responses: expect.any(Boolean), tools: true, vision: true, reasoning: false } },
    { id: 'model3', name: 'model3', meta: expect.any(Object), capabilities: { responses: expect.any(Boolean), tools: false, vision: true, reasoning: false } },
    { id: 'model2', name: 'model2', meta: expect.any(Object), capabilities: { responses: expect.any(Boolean), tools: true, vision: false, reasoning: false } },
  ])
